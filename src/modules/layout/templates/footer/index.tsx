            ...
            <div className="bg-brand-gray-100 mt-5">
                <div className="container mx-auto text-white pt-10 pb-20 lg:pb-7 px-5">
                    <div className="grid md:grid-cols-2 lg:grid-cols-6 text-center md:text-start gap-y-10 gap-6">
                        ...
                        <div className="footer-link flex flex-col space-y-3">
                            <h5>Categories</h5>
                            <Link href="https://store.theshootingcentre.com/firearms/">Firearms</Link>
                            <Link href="https://store.theshootingcentre.com/optics/">Optics</Link>
                            <Link href="https://store.theshootingcentre.com/Linkmmunition/">Ammunition</Link>
                            <Link href="https://store.theshootingcentre.com/reloading/">Reloading</Link>
                            <Link href="https://store.theshootingcentre.com/parts-accessories/">Parts &amp; Accessories</Link>
                            <Link href="https://store.theshootingcentre.com/lifestyle/">Lifestyle</Link>
                            <Link href="https://store.theshootingcentre.com/sale/">SALE!</Link>
                        </div>
                        <div className="footer-link flex flex-col space-y-3">
                            <h5>Info</h5>
                            <p className="text-sm">
                                ...
                                Calgary, AlbertLink T2H 0W3
                            </p>
                            <Link href="tel:+1 (403) 451-1777">Call us: +1 (403) 451-1777</Link>
                        </div>
                ...
                <div className="container mx-auto text-white py-7 px-5">
                    <div className="flex flex-col md:flex-row justify-between text-center md:text-start items-center gap-6">
                        ...
                        <div className="order-first md:order-none flex items-center gap-2.5">
                            <div className="w-16">
                                <Image className="w-full h-full object-contain" src={visaImg} alt="" />
                            </div>
                            <div className="w-16 h-8">
                                <Image className="w-full h-full object-contain" src={cardImg} alt="" />
                            </div>
                            <div className="w-8 h-8">
                                <Image className="w-full h-full object-contain bg-white" src={expressImg} alt="" />
                            </div>
                        </div>
                    </div>
                </div>
