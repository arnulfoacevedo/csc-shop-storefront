...
import bImg1 from "@/public/image/drummond-shooting-logo.png";
      ...
      <div className="relative">
        ...
        >
          <SwiperSlide className="block relative cursor-pointer">
            <Image data-tooltip-target="1" className="w-full h-24 object-contain" src={bImg1} alt="" />
          ...
          <SwiperSlide className="block relative cursor-pointer">
            <Image data-tooltip-target="4" className="w-full h-24 object-contain" src={bImg1} fill alt="" />
          ...
          <SwiperSlide className="block relative cursor-pointer">
            <Image data-tooltip-target="5" className="w-full h-24 object-contain" src={bImg1}
              fill alt="" />
          ...
          <SwiperSlide className="block relative cursor-pointer">
            <Image data-tooltip-target="6" className="w-full h-24 object-contain" src={bImg1} fill alt="" />
          ...
          <SwiperSlide className="block relative cursor-pointer">
            <Image data-tooltip-target="7" className="w-full h-24 object-contain" src={bImg1}
              fill alt="" />
          ...
          <SwiperSlide className="block relative cursor-pointer">
            <Image data-tooltip-target="8" className="w-full h-24 object-contain" src={bImg1}
              fill alt="" />
          ...
          <SwiperSlide className="block relative cursor-pointer">
            <Image data-tooltip-target="9" className="w-full h-24 object-contain" src={bImg1}
              fill alt="" />
          ...
          <SwiperSlide className="block relative cursor-pointer">
            <Image data-tooltip-target="10" className="w-full h-24 object-contain" src={bImg1}
              fill alt="" />
          ...
          <SwiperSlide className="block relative cursor-pointer">
            <Image data-tooltip-target="11" className="w-full h-24 object-contain" src={bImg1} fill alt="" />
